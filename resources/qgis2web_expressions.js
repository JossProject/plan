...
function exp_label_vertice_1_eval_expression(context) {
    // 'P' || id

    var feature = context.feature;
    
    if (feature.properties) {
        return ('P' + feature.get('id') );
    } else {
        return ('P' + feature.get('id') );
    }
}
...
function exp_label_lote_2_eval_expression(context) {
    // 'Area: ' || Area || ' Ha'

    var feature = context.feature;
    
    if (feature.properties) {
        return (('Area: ' + feature.get('Area') ) + ' Ha');
    } else {
        return (('Area: ' + feature.get('Area') ) + ' Ha');
    }
}
...
function exp_label_LINDERO_3_eval_expression(context) {
    // Distance || 'm' || '\n' || Rumbo
